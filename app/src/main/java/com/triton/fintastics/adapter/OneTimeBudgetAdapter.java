...
public class OneTimeBudgetAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OneTimeBudgetAdapter(Context context, List<AccountSummaryResponse.DataBean> dataBeanList) {
