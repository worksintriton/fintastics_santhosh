...
public class TransactionReportListAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private  String TAG = "TransactionReportListAdapter";
    ...
    public TransactionReportListAdapter(Context context, List<IncomeReportResponse.DataBean> dataBeanList) {
