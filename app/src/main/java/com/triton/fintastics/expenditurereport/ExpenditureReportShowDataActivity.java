...
import com.triton.fintastics.adapter.ExpenditureReportListAdapter;
...
public class ExpenditureReportShowDataActivity extends AppCompatActivity {
    ...
    private void setExpenditureReportListView(List<IncomeReportResponse.DataBean> data) {
        ...
        ExpenditureReportListAdapter expenditureReportListAdapter = new ExpenditureReportListAdapter(getApplicationContext(), data);
        rv_expenditurereport.setAdapter(expenditureReportListAdapter);
