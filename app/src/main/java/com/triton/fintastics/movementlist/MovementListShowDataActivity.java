...
public class MovementListShowDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movement_list_show_data);
        ...
        if (extras != null) {
            ...
            Log.w(TAG,"user_id : "+user_id+" start_date : "+start_date+" end_date : "+end_date+" transaction_type : "+transaction_type);
        }
    ...
    private void movementReportResponseCall() {
        avi_indicator.setVisibility(View.VISIBLE);
        avi_indicator.smoothToShow();
        RestApiInterface apiInterface = APIClient.getClient().create(RestApiInterface.class);
        Call<IncomeReportResponse> call = apiInterface.movementReportResponseCall(RestUtils.getContentType(), movementReportDataRequest());
                ...
                if (response.body() != null) {
                    ...
                    if (200 == response.body().getCode()) {
                        if(response.body().getData() != null && response.body().getData().size()>0){
                            ...
                            setMovementReportListView(response.body().getData());
    ...
    private MovementReportDataRequest movementReportDataRequest() {
        /*
         ...
         */
        MovementReportDataRequest movementReportDataRequest = new MovementReportDataRequest();
        movementReportDataRequest.setUser_id(user_id);
        movementReportDataRequest.setStart_date(start_date);
        movementReportDataRequest.setEnd_date(end_date);
        movementReportDataRequest.setTransaction_type(transaction_type);

        Log.w(TAG,"movementReportDataRequest "+ new Gson().toJson(movementReportDataRequest));
        return movementReportDataRequest;
    }
